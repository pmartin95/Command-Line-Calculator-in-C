...
int run_parser_tests(void)
{
    ...
    total++;
    if (test_parser_basic_arithmetic())
        passed++;
    total++;
    if (test_parser_precedence())
        passed++;
    total++;
    if (test_parser_parentheses())
        passed++;
    total++;
    if (test_parser_functions())
        passed++;
    total++;
    if (test_parser_implicit_multiplication())
        passed++;
    total++;
    if (test_parser_unary_operators())
        passed++;
    total++;
    if (test_parser_comparison_operators())
        passed++;
    total++;
    if (test_parser_error_cases())
        passed++;
    total++;
    if (test_parser_complex_expressions())
        passed++;
