...
int run_integration_tests(void)
{
    ...
    total++; if (test_integration_full_pipeline()) passed++;
    total++; if (test_integration_command_processing()) passed++;
    total++; if (test_integration_error_handling()) passed++;
    total++; if (test_integration_precision_consistency()) passed++;
    total++; if (test_integration_memory_management()) passed++;
    total++; if (test_integration_scientific_notation()) passed++;
    total++; if (test_integration_complex_nested_expressions()) passed++;
    total++; if (test_integration_implicit_multiplication_edge_cases()) passed++;
