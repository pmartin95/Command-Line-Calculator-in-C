...
int run_evaluator_tests(void)
{
    ...
    total++;
    if (test_evaluator_basic_arithmetic())
        passed++;
    total++;
    if (test_evaluator_trigonometric_functions())
        passed++;
    total++;
    if (test_evaluator_logarithmic_functions())
        passed++;
    total++;
    if (test_evaluator_other_functions())
        passed++;
    total++;
    if (test_evaluator_comparison_operators())
        passed++;
    total++;
    if (test_evaluator_constants())
        passed++;
    total++;
    if (test_evaluator_complex_expressions())
        passed++;
    total++;
    if (test_evaluator_domain_errors())
        passed++;
    total++;
    if (test_evaluator_implicit_multiplication())
        passed++;
